...
- Step4: Change filename 
     ...
     *Useage* : 
     ...
     bash change_name.sh Lobular_filename_TCGAid.txt
     
     bash change_name.sh Duct_filename_TCGAid.txt
     ...
     *Useage* : 
     ...
     bash name_change.sh Ductgroupchange.txt
     bash name_change.sh Lobulargroupchange.txt
