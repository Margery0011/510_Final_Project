...
colnames(Lobular_Duct_res)[1] <- "Ensembl_ID"
Lobular_Duct_res_geneid <- merge(Ensembl_ID_TO_Genename,Lobular_Duct_res,by="Ensembl_ID")
```
```{r}
write.csv(Lobular_Duct_res_geneid,file="Lobular_Duct_res_geneid_nopoint.csv",row.names = F)
