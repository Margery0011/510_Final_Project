...
Here we specify the gene which  is **ENSG00000006377.10** from the DEG

```{r}
plotCounts(dds, gene="ENSG00000006377.10", intgroup="condition")
```
...
```{r}
d <- plotCounts(dds, gene="ENSG00000006377.10", intgroup="condition", 
                returnData=TRUE)
library("ggplot2")
